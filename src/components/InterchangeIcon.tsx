type InterchangeIconProps = {
  rotate?: boolean
}
const InterchangeIcon = ({ rotate }: InterchangeIconProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={`transition-transform ${rotate ? '': 'rotate-180'}`}>
      <path
        fill="inherit"
